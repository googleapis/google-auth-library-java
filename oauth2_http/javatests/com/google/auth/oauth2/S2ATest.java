...
public class S2ATest {
  ...
  public void getS2AAdress_multipleThreads_validAddress() throws Exception {
    ...
    DoGetS2AAddress doGetS2AAddressA =
        new DoGetS2AAddress(transportFactoryA, S2A_ADDRESS_A, s2aUtils);
    DoGetS2AAddress doGetS2AAddressB =
        new DoGetS2AAddress(transportFactoryB, S2A_ADDRESS_A, s2aUtils);
