...
public final class S2A {
	...
	public static final String MTLS_CONFIG_ENDPOINT = "/instance/platform-security/auto-mtls-configuration";
	...
	/**
	 * Queries the MDS mTLS Autoconfiguration endpoint and returns the S2A address. Returns an empty address on error.
	 */ 
	private String getMdsMtlsConfigData() {
		String s2aAddress = "";
		try {
			if (transportFactory == null) {	
				transportFactory = Iterables.getFirst(ServiceLoader.load(HttpTransportFactory.class), OAuth2Utils.HTTP_TRANSPORT_FACTORY);
			}
