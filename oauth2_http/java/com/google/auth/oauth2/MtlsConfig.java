 ...
 *
 * <p>Instances of {@link MtlsConfig} are not thread safe. Calls to {@code reset}, {@code
 * getS2AAddress}, {@code isValid} and {@code getExpiry} should be made from a synchronized block.
 */
@NotThreadSafe
