...
public class DeleteApiKey {
  ...
  public static void main(String[] args)
    ...
    deleteApiKey(projectId, location, apiKeyId);
  }

  // Delete an API key.
  public static void deleteApiKey(String projectId, String location, String apiKeyId)
      throws IOException, ExecutionException, InterruptedException, TimeoutException {
    ...
    try (ApiKeysClient apiKeysClient = ApiKeysClient.create()) {
      ...
      DeleteKeyRequest deleteKeyRequest = DeleteKeyRequest.newBuilder()
          .setName(String.format("project/%s/locations/%s/keys/%s", projectId, location, apiKeyId))
          .build();
